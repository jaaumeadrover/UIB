...
// Aquí se define la macro LED_BUILTIN = 21 que es el pin 
...
// puerto serie.
// descomentar la siguiente linea si tenemos un "ESP32 Dev Module"
// comentar en caso de tener dos leds internos en la placa de desarrollo
