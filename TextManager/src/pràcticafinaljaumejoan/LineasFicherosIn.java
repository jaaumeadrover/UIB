...
public class LineasFicherosIn {
    ...
    public LineasFicherosIn(String nombre) throws Exception {
    ...
    public int GetNumeroLineas(String a) throws Exception {
        
        LineasFicherosIn ficherolinea;
        
        ficherolinea=new LineasFicherosIn(a);
        
        while(ficherolinea.hayLineas()){
            
            numeroLineas++;
            ficherolinea.lectura();
        }
        return numeroLineas;
    }
